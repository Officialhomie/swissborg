...
// on hover of invest tab 

document.addEventListener("DOMContentLoaded", function () {
    const anchorTagInvest = document.querySelector("a.invest");
    const anchorTagAbout = document.querySelector("a.about");
    ...
    // Create and append the inner content of the div
    const innerContent = document.createElement("div");
    innerContent.classList.add("p-[15px]", "grid", "grid-cols-2", "grid-rows-5", "gap-3");
    
    const innerContent2 = document.createElement("div");
    innerContent2.classList.add("p-[15px]", "grid", "grid-cols-2", "grid-rows-5", "gap-10");
  
    // Add your anchor tag content to the inner content div
    innerContent.innerHTML = `<a class="high" href="">
    ...
    innerContent2.innerHTML = `<a class="high" href="http://127.0.0.1:5501/abouttml">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center justify-between gap-[7px]">
    ...
    divContainer.appendChild(innerContent);
    divContainer2.appendChild(innerContent2);
  
    // Inject the div into the specified location
    document.body.appendChild(divContainer);
    document.body.appendChild(divContainer2);
  
    // Event listener for mouseover event
    anchorTagInvest.addEventListener("mouseover", function () {
      divContainer.classList.remove("hidden");
    });
    anchorTagAbout.addEventListener("mouseover", function () {
      divContainer2.classList.remove("hidden");
    });

    anchorTagInvest.addEventListener("click", function () {
    ...
    anchorTagInvest.addEventListener("mouseout", function () {
      divContainer.classList.add("hidden");
    });
    anchorTagAbout.addEventListener("mouseout", function () {
      divContainer2.classList.add("hidden");
    });
    console.log(anchorTagInvest)
  });

  

// const investTab = document.querySelector('.invest');

// investTab.addEventListener('mouseenter', function() {
//     const divContent = `
...
//     const container = document.querySelector('.invest-modal'); // Replace '.container' with the appropriate selector for your container div
